...
Requires:       python-sgservice-caaclient
...
install -p -D -m 755 etc/sgservice/sgservice.conf.sample %{buildroot}%{_sysconfdir}/sgservice/sgservice.conf
install -p -D -m 755 etc/sgservice/api-paste.ini %{buildroot}%{_sysconfdir}/sgservice/api-paste.ini
install -p -D -m 755 etc/sgservice/policy.json %{buildroot}%{_sysconfdir}/sgservice/policy.json
...
%config(noreplace) %attr(-, root, sgservice) %{_sysconfdir}/sgservice/rootwrap.conf
